    ...
    return (
        <main className="p-3 flex flex-col max-w-6xl mx-auto min-h-screen">
            ...
            <Link to={`/search?category=${post && post.category}`} className="self-center mt-5">
                <Button color={'gray'} pii size={'xs'}>{post && post.category}</Button>
            </Link>
            ...
            <div className="pp-3 max-w-2xl mx-auto w-full post-content" dangerouslySetInnerHTML={{__html:post && post.content}}>
            </div>
